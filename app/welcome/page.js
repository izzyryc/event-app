          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <p
                ...
                style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 900, color: '#36363E' }}
              >
                I'm a Returning Student
              </p>
              <p className="text-sm opacity-60" style={{ color: '#36363E' }}>Log back in with your email and password</p>
            </Link>
